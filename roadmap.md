...
- [x] Centralize language selection and English-first behavior.
- [x] Make English the automatic first-visit language across current routes.
- [x] Keep the complete original French content selectable on every route.
